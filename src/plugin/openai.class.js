class OpenAiClass {
    openAiOptions = { model: '', temperature: 0.8, apiKey: '' }

   // constructor(_options = { model: 'gpt-3.5-turbo-0301', temperature: 0, apiKey: '' }) {     gpt-4-turbo-preview
    constructor(_options = { model: 'gpt-3.5-turbo', temperature: 0.8, apiKey: '' }) {
        if (!_options?.apiKey) {
            throw new Error('apiKey no puede ser vacio')
        }
