...
exports.processMessageQueue = exports.enqueueMessage = void 0;
var messageQueue = [];
var MESSAGE_GAP_SECONDS = 3000;
...
function processMessageQueue() {
    ...
    var combinedMessage = messageQueue.map(function (message) { return message.text; }).join(" ");
